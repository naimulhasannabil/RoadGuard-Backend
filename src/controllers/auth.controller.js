...
export const register = async (req, res, next) => {
  try {
    ...
    const user = await prisma.user.create({
      data: { email, password: hashedPassword, name, phone, vehicleType: vehicleType || "CAR" },
      select: { id: true, email: true, name: true, role: true, level: true, vehicleType: true, createdAt: true },
    })
